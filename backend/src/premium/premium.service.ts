...
export const PREMIUM_TIERS = [
  ...
  },
  {
    ...
    desc_en: 'Navigation with instant road reports, voice guidance, a real-time AI Co-Driver, traffic lights/radars/cameras on the map, and weather & traffic along your route',
    desc_ru: 'Навигация: мгновенные репорты, голосовые подсказки, AI-ассистент Co-Driver в реальном времени, светофоры/радары/камеры на карте, погода и пробки по маршруту',
  },
  {
